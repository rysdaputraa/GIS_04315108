...
basinlabels = mapnik.TextSymbolizer(mapnik.Expression('[NAME]'), 'DejaVu Sans Bold',15,mapnik.Color('black'))
...
mapnik.render_to_file(m, 'cob3.pdf', 'pdf')
print "iki wes metu 'cob3.pdf'"